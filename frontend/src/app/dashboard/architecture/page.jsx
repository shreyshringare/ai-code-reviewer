    ...
    <div className="min-h-screen flex flex-col selection:bg-primary/30 text-on-surface bg-background font-body">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#131317]/80 backdrop-blur-2xl shadow-[0_4px_30px_rgba(0,0,0,0.3)] border-b border-white/5 flex justify-between items-center h-16 px-8 tracking-tight antialiased">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a className="font-sans text-sm font-medium tracking-tight text-[#bdc2ff] border-b-2 border-primary/50 pb-1" href="/dashboard/architecture">Architecture</a>
      ...
      <main className="flex-grow pt-24 pb-12 px-6 lg:px-12 max-w-7xl mx-auto w-full relative z-10">
        <header className="mb-12">
          <h1 className="text-4xl font-headline font-extrabold text-primary-fixed-dim tracking-tight mb-2">Architecture</h1>
          <p className="text-on-surface-variant font-body text-sm max-w-2xl">Visualize module dependencies, import graphs, and architectural patterns detected across your codebase.</p>
        </header>
        ...
        <div className="flex flex-col items-center justify-center min-h-[40vh] rounded-2xl border border-white/5 bg-surface-container-low gap-4">
          <span className="material-symbols-outlined text-primary/40" style={{ fontSize: "64px" }}>account_tree</span>
          <p className="text-on-surface-variant text-sm">Submit a code review from the dashboard to generate an architecture map.</p>
