...
{`          +--------------------------------------------+
          ...
          +--------------------------------------------+`}
            ...
            <div className="mt-20 ml-12 w-64 h-64 wireframe-box rounded-lg flex items-center justify-center border border-dashed border-primary/20">
              <div className="w-48 h-48 border border-primary/10 rounded-full border-dashed flex items-center justify-center relative">
                <div className="wireframe-dot w-1.5 h-1.5 bg-primary/40 rounded-full absolute -top-0.5 left-1/2 -translate-x-1/2"></div>
                <div className="wireframe-dot w-1.5 h-1.5 bg-primary/40 rounded-full absolute -bottom-0.5 left-1/2 -translate-x-1/2"></div>
                <div className="wireframe-dot w-1.5 h-1.5 bg-primary/40 rounded-full absolute top-1/2 -left-0.5 -translate-y-1/2"></div>
                <div className="wireframe-dot w-1.5 h-1.5 bg-primary/40 rounded-full absolute top-1/2 -right-0.5 -translate-y-1/2"></div>
              </div>
            </div>
          </div>
      ...
      <header className="absolute top-0 left-0 right-0 p-8 flex justify-between items-center z-20 max-w-7xl mx-auto w-full">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-on-surface-variant/80">
          ...
          <a className="bg-surface-container-high px-4 py-2 rounded-lg border border-outline-variant/30 hover:bg-surface-container-highest transition-all" href="/auth/login">Sign In</a>
        </nav>
      </header>
      ...
      <main className="w-full h-full flex items-center justify-center px-6 relative z-10">
        <div className="w-full max-w-md space-y-10">
          ...
          <div className="glass-panel p-10 rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
            ...
            <footer className="text-center pt-8">
              <p className="text-[13px] text-on-surface-variant/80">
                ...
                <a className="text-primary font-bold hover:underline underline-offset-4 transition-all ml-1" href="/auth/login">Log in</a>
              </p>
            </footer>
          </div>
        </div>
